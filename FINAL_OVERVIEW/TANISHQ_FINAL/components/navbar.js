function navbar(){
    ...
    <div id = "mediaQ">
        ...
        <div id='nav-m-bottom'>
            <div id = "ham">
                <div><i class="material-icons" id = "menu">menu</i></div>
                <div><img src="https://www.tanishq.co.in/wps/wcm/connect/tanishq/c5124844-8ad5-41af-99bd-1e561480f9fb/TanishqLogo-mobile.png?MOD=AJPERES&CACHEID=ROOTWORKSPACE.Z18_90IA1H80O0RT10QIMVSTFU3006-c5124844-8ad5-41af-99bd-1e561480f9fb-mC0fAsK" alt=""></div>
                <div><i class="material-icons" id = "me_search">search</i></div>
            </div>
        </div>
...
<div id = "page_layout">
    ...
    <div id = "search_div">
        <div id = "search_div2">
            <div>
                <input type="text" name=""  id="search_inp" placeholder="Search our Products..."><i class="material-icons" id = "mic">mic</i><i class="material-icons" id = "mic_sea">search</i>
            </div>
            <div id = "search_grid">
                <div>
                ...
                <div>
                    ...
                    <div id = "popu_grid1">
                        ...
                        <div>
                            <p>10 gram 24 Karat Gold Coin</p>
                            <p>600212ZCDRBS00</p>
                            <p></p>
                        </div>
                    </div>
